...
{
    /** @var array Based on RFC-7231 */
    public static $reasonPharses = [
        100 => 'Continue',
    ...
    public function __construct(
        ...
        if ('' === $reason && isset(self::$reasonPharses[$this->statusCode])) {
            $this->reasonPhrase = self::$reasonPharses[$this->statusCode];
        } else {
    ...
    public function getHeaders()
    {
        ...
        foreach ($this->headers as $name => $value) {
            $headers[$this->headersNames[$name]] = [$value];
        }
    ...
    public function withoutHeader($name)
    {
        ...
        $response = clone $this;
        unset($response->headersNames[$name], $response->headers[$name]);
    ...
    public function withStatus($code, $reasonPhrase = '')
    {
        ...
        if ('' === $reasonPhrase && isset(self::$reasonPharses[$code])) {
            $response->reasonPhrase = self::$reasonPharses[$code];
        } else {
